...
module T::Props::Serializable
  ...
  private def __t_props_generated_deserialize(hash)
    ...
    #
    # To see the definition for class `Foo`, run:
    #
    # ```
    #   T::Props::Private::DeserializerGenerator.generate_deserializer(
    #     T::Props::Serializable::DecoratorMethods::DESERIALIZE_METHOD,
    #     Foo.props,
    #   )
    # ```
    0
...
module T::Props::Serializable::DecoratorMethods
  ...
  def add_prop_definition(prop, rules)
    ...
    enqueue_lazy_method_definition!(:__t_props_generated_deserialize) do
      T::Props::Private::DeserializerGenerator.generate_deserializer(
        DESERIALIZE_METHOD,
        props,
      )
